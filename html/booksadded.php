...
<?php session_start(); 
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div id="alternate-navbar">
        <ul class="nav nav-justified">
          ...
          <li class="active hov"><a href="../html/booksadded.php?content=booksadded">Books Added</a></li>
      ...
      <div class = "col-md-8 addedsearch" id = "search">
      <table id = "searchbox">
          <tr>
    ...
    <br />
      <h2 style='margin-left:17px; margin-top:110px;'>Books Added</h2>
      <div id="result" style='margin-top:10px;' class = "col-md-12">
